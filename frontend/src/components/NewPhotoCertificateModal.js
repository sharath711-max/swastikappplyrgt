...
const NewPhotoCertificateModal = ({ show, onHide, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await runModalSubmit({
                action: async () => {
                    if (!preventDuplicateCreate('PC', selectedCustomer.id))
                        throw new Error('Duplicate photo certificate submission blocked');
                    ...
                    addToast(`Photo Certificate created — ${sampleRows.length} item(s)`, 'success');
                },
                reload: onSuccess,
            ...
            if (err.message === 'Duplicate photo certificate submission blocked') {
                addToast('Photo Certificate creation is already in progress', 'warning');
                return;
            }
        ...
        <Modal show={show} onHide={closeSafely} backdrop="static" centered dialogClassName="modal-xxl">
            ...
            <Modal.Body className="m-3 mb-0">
                ...
                <PrerequisiteBanner>
                    ...
                    No prior test is required; ensure the source items match what was actually weighed.
                </PrerequisiteBanner>
                    ...
                    <div id="sampleDetailsBlock">
                        ...
                        <div id="sampleDetailsContainer">
                            {sampleRows.map((row, idx) => (
                                <div className="sampleDetails input-group input-group-lg mb-1" key={row.id}>
...
export default NewPhotoCertificateModal;
